...
const withNonCaptureGrouping = (text: string): string => `(?:${text})`;
...
export const occurs: SetFrequency = (text, amount) => `${text}{${amount}}`;
export const doesNotOccur: ModifyText = (text) => `[^${text}]`;
export const occursAtLeast: SetFrequency = (text, min) => `${text}{${min},}`;
export const occursOnceOrMore: ModifyText = (text) => `${text}+`;
export const occursZeroOrMore: ModifyText = (text) => `${text}*`;
...
export const atStart: ModifyText = (text) => `^${text}`; // careful of grouping
export const atEnd: ModifyText = (text) => `${text}$`; // careful of grouping;
